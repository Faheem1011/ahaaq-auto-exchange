...
export default function FinanceCentre() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative w-full pt-44 pb-32 bg-zinc-950 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full text-center space-y-8">
          ...
          {/* Partnership Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-[11px] font-black tracking-widest uppercase shadow-lg">
            <ShieldCheck size={14} /> Official Credit Acceptance Dealer • Code: DCX3C
          </div>

          <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-white uppercase leading-tight max-w-5xl mx-auto">
            Online Car <span className="text-emerald-400">Financing Approval</span> in Jacksonville
          </h1>

          <p className="text-base md:text-lg text-zinc-300 max-w-3xl mx-auto font-medium leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center items-center gap-4 max-w-2xl mx-auto">
            <FinancingCtaModal 
              buttonText="Apply Online (English)"
              buttonClassName="w-full sm:w-auto px-8 py-4.5 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-zinc-950 font-black text-xs uppercase tracking-widest rounded-full transition-all shadow-xl shadow-emerald-950/50 flex items-center justify-center gap-2 cursor-pointer"
            ...
            <a 
              ...
              className="w-full sm:w-auto px-8 py-4.5 bg-zinc-900 hover:bg-zinc-800 text-white font-black text-xs uppercase tracking-widest rounded-full border border-zinc-700 transition-all flex items-center justify-center gap-2 shadow-lg"
            >
      ...
      <section className="py-16 px-8 max-w-7xl mx-auto">
        <div className="bg-gradient-to-r from-zinc-900 via-zinc-950 to-zinc-900 border border-zinc-800 rounded-3xl p-8 md:p-12 text-white shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 shrink-0 bg-white/5 border border-white/10 p-6 rounded-2xl">
            <div className="text-center">
              <div className="w-32 h-32 bg-white rounded-xl p-2.5 shadow-xl mx-auto mb-2 flex items-center justify-center">
                <img 
      ...
      <section className="py-24 bg-zinc-950 text-white px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-sm font-bold tracking-[0.2em] text-emerald-400 uppercase">The Ahaaq Advantage</h2>
            <h3 className="text-3xl md:text-4xl font-black tracking-tight uppercase">Why Finance With Credit Acceptance?</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="flex flex-col items-center space-y-4">
              <CheckCircle className="w-12 h-12 text-emerald-400" />
              <h4 className="text-xl font-bold">All Credit Types Welcome</h4>
              <p className="text-zinc-400 font-medium">We specialize in approvals for rebuilding credit, first-time buyers, and established credit alike. Your past does not define your future at Ahaaq.</p>
            </div>
            <div className="flex flex-col items-center space-y-4">
              <ShieldCheck className="w-12 h-12 text-emerald-400" />
              <h4 className="text-xl font-bold">100% Confidential Underwriting</h4>
              <p className="text-zinc-400 font-medium">Your credit application is processed directly through Credit Acceptance's encrypted system, guaranteeing complete privacy and peace of mind.</p>
            </div>
            <div className="flex flex-col items-center space-y-4">
              <CarFront className="w-12 h-12 text-emerald-400" />
              <h4 className="text-xl font-bold">Zero Down &amp; Deferred Payments</h4>
              <p className="text-zinc-400 font-medium">Many programs allow zero-down financing with deferred first payments up to 60 days on eligible vehicles in our Jacksonville inventory.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-8 max-w-4xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <h3 className="text-3xl md:text-4xl font-black tracking-tight text-zinc-900 uppercase">Credit Acceptance FAQ</h3>
        </div>

        <div className="space-y-8">
          <div>
            <h4 className="text-xl font-bold text-zinc-900 mb-2">How fast will I know my approval status?</h4>
            <p className="text-zinc-600 font-medium">Most Credit Acceptance applications provide an immediate decision online. Bobby Ali and our team will then contact you to finalize the deal and schedule your test drive.</p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-zinc-900 mb-2">Can I apply in Spanish?</h4>
            <p className="text-zinc-600 font-medium">Yes! Credit Acceptance provides a complete Spanish application portal. Simply select the Spanish option or visit <code className="text-zinc-800">/credit-application/DCX3C?lang=es</code>.</p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-zinc-900 mb-2">What documents should I bring to the dealership?</h4>
            <p className="text-zinc-600 font-medium">Bring your valid driver's license, proof of insurance, recent pay stubs or bank statements for income verification, and your trade-in's title or registration if applicable.</p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-zinc-900 mb-2">Will applying online guarantee my car?</h4>
            <p className="text-zinc-600 font-medium">Applying online pre-arranges your credit approval so you can lock in terms. We recommend contacting us at 904-502-9709 immediately after applying so we can hold your vehicle for your visit.</p>
          </div>
        </div>
      </section>
