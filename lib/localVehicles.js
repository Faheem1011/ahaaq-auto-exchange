...
export const localVehicles = [
  {
    ...
    slug: "2006-acura-tl",
    status: "available",
    tags: ["Luxury", "Leather", "Sunroof", "V6 VTEC", "Heated Seats"],
    videoUrl: "",
    content: "<p>Immaculate 2006 Acura TL with 3.2L V6 VTEC power and smooth automatic transmission. Features gorgeous black leather interior with heated seats, power sunroof, premium sound system, dual exhaust, and alloy wheels. Cold AC and pristine mechanical condition. Ready for immediate delivery in Jacksonville, FL!</p>",
    featuredImage: {
      node: {
